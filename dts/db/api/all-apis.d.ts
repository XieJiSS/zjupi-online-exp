declare const _default: {
    ...
    getAllRemoteClientsAttrsOnly: <T extends "password" | "online" | "clientId" | "passwordExpireAt" | "nextPassword" | "ip" | "lastActive" | "isDead" | "linkId">(attributes: readonly T[]) => Promise<import("../../types/type-helper").TModelListAttrsOnly<import("../models/RemoteClient").RemoteClientModelCtor, T>>;
    ...
    getRemoteClientByIdAttrsOnly: <T_1 extends "password" | "online" | "clientId" | "passwordExpireAt" | "nextPassword" | "ip" | "lastActive" | "isDead" | "linkId">(clientId: string, attributes: readonly T_1[]) => Promise<import("../../types/type-helper").TModelAttrsOnly<import("../models/RemoteClient").RemoteClientModelCtor, T_1>>;
    ...
    getAllStudentsAttrsOnly: <T_2 extends "name" | "linkId" | "studentId" | "phone">(attributes: readonly T_2[]) => Promise<import("../../types/type-helper").TModelListAttrsOnly<import("../models/Student").StudentModelCtor, T_2>>;
    getStudentById: (studentId: number) => Promise<import("../models/Student").StudentModel>;
    getStudentByIdAttrsOnly: <T_3 extends "name" | "linkId" | "studentId" | "phone">(studentId: number, attributes: readonly T_3[]) => Promise<import("../../types/type-helper").TModelAttrsOnly<import("../models/Student").StudentModelCtor, T_3>>;
    getStudentByLinkId: (linkId: number) => Promise<import("../models/Student").StudentModel>;
    getStudentByLinkIdAttrsOnly: <T_4 extends "name" | "linkId" | "studentId" | "phone">(linkId: number, attributes: readonly T_4[]) => Promise<import("../../types/type-helper").TModelAttrsOnly<import("../models/Student").StudentModelCtor, T_4>>;
    ...
    getLinkByIdAttrsOnly: <T_5 extends "createdAt" | "clientId" | "linkId" | "cameraId" | "linkPath" | "validAfter" | "validUntil" | "isValid">(linkId: number, attributes: readonly T_5[]) => Promise<import("../../types/type-helper").TModelAttrsOnly<import("../models/AccessLink").AccessLinkModelCtor, T_5>>;
    ...
    getAllLinksAttrsOnly: <T_6 extends "createdAt" | "clientId" | "linkId" | "cameraId" | "linkPath" | "validAfter" | "validUntil" | "isValid">(attributes: readonly T_6[]) => Promise<import("../../types/type-helper").TModelListAttrsOnly<import("../models/AccessLink").AccessLinkModelCtor, T_6>>;
    getAllValidLinks: () => Promise<import("../models/AccessLink").AccessLinkModel[]>;
    getAllValidLinksAttrsOnly: <T_7 extends "createdAt" | "clientId" | "linkId" | "cameraId" | "linkPath" | "validAfter" | "validUntil" | "isValid">(attributes: readonly T_7[]) => Promise<import("../../types/type-helper").TModelListAttrsOnly<import("../models/AccessLink").AccessLinkModelCtor, T_7>>;
    ...
    getAllLogsAttrsOnly: <T_8 extends "source" | "text" | "createdAt" | "logId" | "level">(attributes: readonly T_8[]) => Promise<import("../../types/type-helper").TModelListAttrsOnly<import("../models/DBLog").DBLogModelCtor, T_8>>;
    getLogById: (logId: number) => Promise<import("../models/DBLog").DBLogModel>;
    getLogByIdAttrsOnly: <T_9 extends "source" | "text" | "createdAt" | "logId" | "level">(logId: number, attributes: readonly T_9[]) => Promise<import("../../types/type-helper").TModelAttrsOnly<import("../models/DBLog").DBLogModelCtor, T_9>>;
    ...
    getCameraByIdAttrsOnly: <T_10 extends keyof import("../models/Camera").CameraAdditionalModelAttributesReadonly | keyof import("../models/Camera").CameraCreationAttributes>(cameraId: string, attributes: readonly T_10[]) => Promise<import("../../types/type-helper").TModelAttrsOnly<import("../models/Camera").CameraModelCtor, T_10>>;
    ...
    getAllCamerasAttrsOnly: <T_11 extends keyof import("../models/Camera").CameraAdditionalModelAttributesReadonly | keyof import("../models/Camera").CameraCreationAttributes>(attributes: readonly T_11[]) => Promise<import("../../types/type-helper").TModelListAttrsOnly<import("../models/Camera").CameraModelCtor, T_11>>;
    getAllOnlineCameras: () => Promise<import("../models/Camera").CameraModel[]>;
    getAllOnlineCamerasAttrsOnly: <T_12 extends keyof import("../models/Camera").CameraAdditionalModelAttributesReadonly | keyof import("../models/Camera").CameraCreationAttributes>(attributes: readonly T_12[]) => Promise<import("../../types/type-helper").TModelListAttrsOnly<import("../models/Camera").CameraModelCtor, T_12>>;
