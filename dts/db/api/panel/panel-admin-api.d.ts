...
declare function getAdminByPhone(phone: string): Promise<import("../../models/Admin").AdminModel | null>;
declare function createAdmin(username: string, phone: string, password: string): Promise<import("../../models/Admin").AdminModel | null>;
...
declare const _default: {
    ...
    getAdminByPhone: typeof getAdminByPhone;
