...
declare function getAdminByUsername(username: string): Promise<import("../../models/Admin").AdminModel>;
declare function getAdminById(adminId: number): Promise<import("../../models/Admin").AdminModel>;
declare function createAdmin(username: string, password: string): Promise<import("../../models/Admin").AdminModel>;
