declare const _default: {
    ...
    getStudentByIdAttrsOnly: <T_1 extends "name" | "linkId" | "studentId" | "phone">(studentId: number, attributes: readonly T_1[]) => Promise<import("../../../types/type-helper").TPartialModel<import("../../models/Student").StudentModel, T_1>>;
    getStudentByLinkId: (linkId: number) => Promise<import("../../models/Student").StudentModel>;
    getStudentByLinkIdAttrsOnly: <T_2 extends "name" | "linkId" | "studentId" | "phone">(linkId: number, attributes: readonly T_2[]) => Promise<import("../../../types/type-helper").TPartialModel<import("../../models/Student").StudentModel, T_2>>;
    ...
    getLinkByIdAttrsOnly: <T_3 extends "createdAt" | "clientId" | "linkId" | "cameraId" | "linkPath" | "validAfter" | "validUntil" | "isValid">(linkId: number, attributes: readonly T_3[]) => Promise<import("../../../types/type-helper").TPartialModel<import("../../models/AccessLink").AccessLinkModel, T_3>>;
