...
declare const _default: {
    ...
    getAllStudentsAttrsOnly: <T extends "name" | "linkId" | "phone" | "studentId">(attributes: readonly T[]) => Promise<import("../../../types/type-helper").TPartialModelArr<import("../../models/Student").StudentModel, T>>;
    getStudentById: (studentId: number) => Promise<import("../../models/Student").StudentModel | null>;
    getStudentByIdAttrsOnly: <T_1 extends "name" | "linkId" | "phone" | "studentId">(studentId: number, attributes: readonly T_1[]) => Promise<import("../../../types/type-helper").TPartialModel<import("../../models/Student").StudentModel, T_1> | null>;
    getStudentByLinkId: (linkId: number) => Promise<import("../../models/Student").StudentModel | null>;
    getStudentByLinkIdAttrsOnly: <T_2 extends "name" | "linkId" | "phone" | "studentId">(linkId: number, attributes: readonly T_2[]) => Promise<import("../../../types/type-helper").TPartialModel<import("../../models/Student").StudentModel, T_2> | null>;
    ...
    getLinkByIdAttrsOnly: <T_3 extends "createdAt" | "clientId" | "linkId" | "cameraId" | "isValid" | "linkPath" | "validAfter" | "validUntil">(linkId: number, attributes: readonly T_3[]) => Promise<import("../../../types/type-helper").TPartialModel<import("../../models/AccessLink").AccessLinkModel, T_3> | null>;
    ...
    getAllLinksAttrsOnly: <T_4 extends "createdAt" | "clientId" | "linkId" | "cameraId" | "isValid" | "linkPath" | "validAfter" | "validUntil">(attributes: readonly T_4[]) => Promise<import("../../../types/type-helper").TPartialModelArr<import("../../models/AccessLink").AccessLinkModel, T_4>>;
    getAllValidLinks: () => Promise<import("../../models/AccessLink").AccessLinkModel[]>;
    getAllValidLinksAttrsOnly: <T_5 extends "createdAt" | "clientId" | "linkId" | "cameraId" | "isValid" | "linkPath" | "validAfter" | "validUntil">(attributes: readonly T_5[]) => Promise<import("../../../types/type-helper").TPartialModelArr<import("../../models/AccessLink").AccessLinkModel, T_5>>;
