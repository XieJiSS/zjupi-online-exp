...
export declare function getSequelizeSessionStore(sessionStore: typeof Store): {
    sync(options?: import("sequelize").SyncOptions | undefined): void;
    touch: (sid: string, data: any, callback?: ((err: any) => void) | undefined) => void;
    stopExpiringSessions: () => void;
    get(sid: string, callback: (err: any, session?: import("express-session").SessionData | null | undefined) => void): void;
    set(sid: string, session: import("express-session").SessionData, callback?: ((err?: any) => void) | undefined): void;
    ...
    load(sid: string, callback: (err: any, session?: import("express-session").SessionData | undefined) => any): void;
    ...
    } | import("express-session").SessionData[] | null | undefined) => void): void;
