 ...
 */
export function getSequelizeSessionStore(sessionStore: typeof import("express-session").Store): {
    ...
    regenerate(req: import("express").Request<import("express-serve-static-core").ParamsDictionary, any, any, qs.ParsedQs, Record<string, any>>, callback: (err?: any) => any): void;
    load(sid: string, callback: (err: any, session?: import("express-session").SessionData) => any): void;
    createSession(req: import("express").Request<import("express-serve-static-core").ParamsDictionary, any, any, qs.ParsedQs, Record<string, any>>, session: import("express-session").SessionData): import("express-session").Session & import("express-session").SessionData;
